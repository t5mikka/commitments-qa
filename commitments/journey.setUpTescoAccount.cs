...
{
    internal class setUpTescoAccountClass
    {
        public static void setUpTescoAccount()
        {
            ...
            // [Sign in mock tax service] Check heading displays "Authority to interact with HMRC on your behalf"
